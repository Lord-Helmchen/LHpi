...
[792] = { name="Commander’s Arsenal",
	foilonly=true,
	cardcount={ reg=18, tok=0, nontr=0, overs=10 }, 
},
...
[789] = { name="From the Vault: Realms",
	foilonly=true,
	cardcount={ reg=15, tok=0, nontr=0, overs=0 }, 
},
[787] = { name="Planechase 2012",
	foil="n",
	cardcount={ reg=156, tok=0, nontr=40, overs=0 }, 
	variants={
["Plains"] 						= { "Plains"	, { 1    , 2    , 3    , 4    , 5     } },
["Island"] 						= { "Island" 	, { 1    , 2    , 3    , 4    , 5     } },
["Swamp"] 						= { "Swamp"		, { 1    , 2    , 3    , 4    , 5     } },
...
[783] = { name="Premium Deck Series: Graveborn",
	foilonly=true,
	cardcount={ reg=30, tok=0, nontr=0, overs=0 }, 
	variants={
["Swamp"] 						= { "Swamp"		, { 1    , 2    , 3    , 4     } },
...
[781] = { name="Duel Decks: Ajani vs. Nicol Bolas",
	foil="n",
	cardcount={ reg=80, tok=2, nontr=0, overs=0 }, 
	variants={
["Swamp"] 						= { "Swamp"		, { 1    , 2     } },
["Mountain"] 					= { "Mountain"	, { 1    , 2     } },
["Forest"] 						= { "Forest"	, { 1    , 2     } },
...
[778] = { name="Commander",
	foil="n", -- 15 oversized are foilonly
	cardcount={ reg=318, tok=0, nontr=0, overs=15 },
	variants={
["Plains"] 						= { "Plains"	, { 1    , 2    , 3    , 4     } },
["Island"] 						= { "Island" 	, { 1    , 2    , 3    , 4     } },
["Swamp"] 						= { "Swamp"		, { 1    , 2    , 3    , 4     } },
...
[777] = { name="Duel Decks: Knights vs. Dragons",
	foil="n",
	cardcount={ reg=81, tok=1, nontr=0, overs=0 }, 
	variants={
["Plains"] 						= { "Plains"	, { 1    , 2    , 3    , 4     } },
["Mountain"] 					= { "Mountain"	, { 1    , 2    , 3    , 4     } },
["Forest"] 						= { "Forest"	, { 1    , 2    , 3    , 4     } },
...
[774] = { name="Premium Deck Series: Fire and Lightning",
	foilonly=true,
	cardcount={ reg=34, tok=0, nontr=0, overs=0 }, 
	variants={
["Mountain"] 					= { "Mountain"	, { 1    , 2    , 3    , 4     } },
...
[769] = { name="Archenemy",
	foil="n",
	cardcount={ reg=150, tok=0, nontr=45, overs=0 }, 
	variants={
["Plains"] 						= { "Plains"	, { 1    , 2     } },
["Island"] 						= { "Island" 	, { 1    , 2    , 3     } },
["Swamp"] 						= { "Swamp"		, { 1    , 2    , 3     } },
...
[768] = { name="Duels of the Planeswalkers",
	foil="n",
	cardcount={ reg=113, tok=0, nontr=0, overs=0 }, 
	variants={
["Island"] 						= { "Island" 	, { 1    , 2    , 3    , 4     } },
["Swamp"] 						= { "Swamp"		, { 1    , 2    , 3    , 4     } },
["Mountain"] 					= { "Mountain"	, { 1    , 2    , 3    , 4     } },
...
[766] = { name="Duel Decks: Phyrexia vs. The Coalition",
	foil="n",
	cardcount={ reg=71, tok=3, nontr=0, overs=0 }, 
	variants={
["Swamp"] 						= { "Swamp"		, { 1    , 2    , 3    , 4     } },
["Forest"] 						= { "Forest" 	, { 1    , 2     } },
...
[764] = { name="Premium Deck Series: Slivers",
	foilonly=true,
	cardcount={ reg=41, tok=0, nontr=0, overs=0 }, 
},
[763] = { name="Duel Decks: Garruk vs. Liliana",
	foil="n",
	cardcount={ reg=63, tok=3, nontr=0, overs=0 }, 
	variants={
["Swamp"] 						= { "Swamp"		, { 1    , 2    , 3    , 4     } },
["Forest"] 						= { "Forest" 	, { 1    , 2    , 3    , 4     } },
...
[761] = { name="Planechase",
	foil="n",
	cardcount={ reg=169, tok=0, nontr=40, overs=0 }, 
	variants={
["Plains"] 						= { "Plains" 	, { 1    , 2    , 3    , 4    , 5     } },
["Island"] 						= { "Island"	, { 1    , 2    , 3    , 4     } },
["Swamp"] 						= { "Swamp"		, { 1    , 2    , 3    , 4    , 5     } },
...
[755] = { name="Duel Decks: Jace vs. Chandra",
	foil="n",
	cardcount={ reg=62, tok=1, nontr=0, overs=0 }, 
	variants={
["Island"] 						= { "Island"	, { 1    , 2    , 3    , 4     } },
["Mountain"] 					= { "Mountain"	, { 1    , 2    , 3    , 4     } },
...
[675] = { name="Coldsnap Theme Decks",
	foil="n",
	cardcount={ reg=62, tok=0, nontr=0, overs=0 }, 
	variants={
["Plains"] 						= { "Plains"	, { 1    , 2    , 3     } },
["Island"] 						= { "Island" 	, { 1    , 2    , 3     } },
["Swamp"] 						= { "Swamp"		, { 1    , 2    , 3     } },
...
[490] = { name="Deckmasters",
	foil="n",
	cardcount={ reg=58, tok=0, nontr=0, overs=0 }, 
	variants={
["Swamp"] 						= { "Swamp"		, { 1    , 2    , 3     } },
["Mountain"] 					= { "Mountain"	, { 1    , 2    , 3     } },
["Forest"] 						= { "Forest" 	, { 1    , 2    , 3     } },
...
[405] = { name="Battle Royale Box Set",
	foil="n",
	cardcount={ reg=136, tok=0, nontr=0, overs=0 }, 
	variants={
...
[390] = { name="Starter 1999",
	foil="n",
	cardcount={ reg=173, tok=0, nontr=0, overs=0 }, 
	variants={
["Plains"] 					= { "Plains"	, { 1    , 2    , 3    , 4     } },
["Island"] 					= { "Island" 	, { 1    , 2    , 3    , 4     } },
["Swamp"] 					= { "Swamp"		, { 1    , 2    , 3    , 4     } },
...
[340] = { name="Anthologies",
	foil="n",
	cardcount={ reg=85, tok=0, nontr=0, overs=0 }, 
	variants={
["Plains"] 						= { "Plains" 	, { 1    , 2     } },
["Swamp"] 						= { "Swamp"		, { 1    , 2     } },
["Mountain"] 					= { "Mountain"	, { 1    , 2     } },
...
[235] = { name="Multiverse Gift Box",
	foil="n",
	cardcount={ reg=10, tok=0, nontr=0, overs=0 }, 
},
[225] = { name="Introductory Two-Player Set",
	foil="n",
	cardcount={ reg=67, tok=0, nontr=0, overs=0 }, 
	variants={
["Plains"] 						= { "Plains"	, { 1    , 2    , 3     } },
["Island"] 						= { "Island" 	, { 1    , 2    , 3     } },
["Swamp"] 						= { "Swamp"		, { 1    , 2    , 3     } },
...
[70] = { name="Vanguard",
	foil="n",
	cardcount={ reg=0, tok=0, nontr=32, overs=0 }, 
},
[69] = { name="Box Topper Cards",
	foil="n",
	cardcount={ reg=0, tok=0, nontr=0, overs=52 }, 
	variants={
["Ambition’s Cost"]			= { "8ED" },
...
[31] = { name="Grand Prix Promos",
	foilonly=true,
	cardcount={ reg=8, tok=0, nontr=0, overs=0 }, 
},
[30] = { name="Friday Night Magic Promos",
	foilonly=true,
	cardcount={ reg=167, tok=1, nontr=0, overs=0 }, 
	foiltweak={
...
[26] = { name="Game Day Promos",
	...
	cardcount={ reg=42, tok=0, nontr=2, overs=0 }, 
	foiltweak={
