...
--- @field [parent=#site] #table sets
site.sets = {
--TODO decide SZH not in MA: [9]=false or expected fails ?
 -- Core sets
...
-- special sets
[796]={id = 796,	lang = { true,		[9]=false },	fruc = { true, true},	pages=2, url = "Modern+Masters"},
...
site.namereplace = {
[797] = { -- M2014
["Elemental Token(7/13)"]				= "Elemental (7)",
["Elemental Token (8/13)"]				= "Elemental (8)",
},
[770] = { -- M11
...
["Soldier Token(2/11)"]					= "Soldier (2)",
["Soldier Token(3/11)"]					= "Soldier (3)",
["Soldier Token(7/11)"]					= "Soldier (7)",
},
[795] = { -- Dragon's Maze
...
["Elemental Token"]						= "Elemental", -- TODO need to grep P/T to have parseHtmlData seperate the two
},
[730] = { -- Lorwyn
["Elemental Token"]						= "Elemental", -- not enough info to seperate the two
},
...
[770] = { namereplaced=4, dropped=1, pset={ [9]=249 }, failed={[9]=5} },-- fail SZH tokens
[759] = { pset={ 257-3, [9]=249-20 }, failed={[9]=8}, dropped=8 },-- missing 3 ENG Forest, fail SZH tokens
[720] = { pset={ [9]=383-20 }, failed={[9]=6}, dropped=3 }, -- no SZH lands, fail SZH tokens	
[630] = { pset={ 359-31 } },
[550] = { pset={ 357-27 } },
[460] = { pset={ 350-20 }, dropped=3 },
[360] = { pset={ 350-20 }, dropped=19 },
[250] = { pset={ 449-20 }, dropped=51 },
[180] = { pset={ 378-15 }, dropped=89 },
[140] = { pset={ 306-15 }, dropped=31, namereplaced=1 },
[110] = { dropped=3 },
[100] = { pset={ 302-19 } },
[90]  = {namereplaced=4},
-- Expansions
[800] = {namereplaced=9, pset={[9]=249}, failed={[9]=9}},-- fail SZH tokens
...
[782] = { pset={ 276+1, [9]=264 }, failed={[9]=9}, namereplaced=19 },-- fail SZH tokens, +1 is Checklist
...
[756] = { pset={ [9]=145 } },-- no SZH tokens
[754] = { pset={ [9]=249 }, failed={[9]=9}, dropped=1, namereplaced=1 },-- fail SZH tokens
...
[730] = { pset={ 312-1, [9]=301-1 }, failed={[9]=10}, dropped=2, namereplaced=4 },-- -1 is missing "Lys Alana Scarblade" (ENG), "Changeling Berserker" (SZH), fail SZH tokens
[710] = { dropped=2 },
[700] = { dropped=1 },
...
[510] = { dropped=16 },
[500] = { dropped=9 },
[480] = { pset={ 350-20 }, 	dropped=31 },
[470] = { dropped=4, namereplaced=1 },
[450] = { pset={ 146-3 }, dropped=23 },
[430] = { dropped=100 },
[420] = { pset={ 143-60 }, dropped=8 },
[410] = { pset={ 143-1 }, dropped=12 },
[400] = { pset={ 350-20 }, dropped=15 },
[370] = { dropped=11 },
[350] = { dropped=12 },
[330] = { pset={ 350-20 }, dropped=37 }, -- no lands
[300] = { dropped=11 },
[290] = { dropped=24 },
[280] = { pset={ 350-20 }, dropped=55 },
[270] = { dropped=9 },
[240] = { dropped=11 },
[230] = { pset={ 350-21 }, dropped=76 },
[220] = { dropped=11 },
[210] = { dropped=7 },
[190] = { pset={ 383-15 }, dropped=90 },-- no Basiclands
[170] = { dropped=20 },
[160] = { dropped=9 },
[150] = { dropped=22, namereplaced=1 },
[130] = { dropped=7, namereplaced=1 },
[120] = { dropped=15, namereplaced=2 },
-- special sets
[796] = { namereplaced=6}
}
end
